...
namespace Library
{
	RTTI_DEFINITIONS( SpotLightSkinnedModelMaterial )

		SpotLightSkinnedModelMaterial::SpotLightSkinnedModelMaterial()
		: Material( "main11" ),
		...
		MATERIAL_VARIABLE_INITIALIZATION( LightPosition ), MATERIAL_VARIABLE_INITIALIZATION( LightLookAt ),
		MATERIAL_VARIABLE_INITIALIZATION( LightRadius ), MATERIAL_VARIABLE_INITIALIZATION( SpotLightInnerAngle ),
		MATERIAL_VARIABLE_INITIALIZATION( SpotLightOuterAngle ), MATERIAL_VARIABLE_INITIALIZATION( CameraPosition ),
		MATERIAL_VARIABLE_INITIALIZATION(BoneTransforms),		MATERIAL_VARIABLE_INITIALIZATION( ColorTexture )
	{ }

	MATERIAL_VARIABLE_DEFINITION( SpotLightSkinnedModelMaterial, WorldViewProjection )
		MATERIAL_VARIABLE_DEFINITION( SpotLightSkinnedModelMaterial, World )
		MATERIAL_VARIABLE_DEFINITION( SpotLightSkinnedModelMaterial, SpecularColor )
		MATERIAL_VARIABLE_DEFINITION( SpotLightSkinnedModelMaterial, SpecularPower )
		MATERIAL_VARIABLE_DEFINITION( SpotLightSkinnedModelMaterial, AmbientColor )
		MATERIAL_VARIABLE_DEFINITION( SpotLightSkinnedModelMaterial, LightColor )
		MATERIAL_VARIABLE_DEFINITION( SpotLightSkinnedModelMaterial, LightPosition )
		MATERIAL_VARIABLE_DEFINITION( SpotLightSkinnedModelMaterial, LightLookAt )
		MATERIAL_VARIABLE_DEFINITION( SpotLightSkinnedModelMaterial, LightRadius )
		MATERIAL_VARIABLE_DEFINITION( SpotLightSkinnedModelMaterial, SpotLightInnerAngle )
		MATERIAL_VARIABLE_DEFINITION( SpotLightSkinnedModelMaterial, SpotLightOuterAngle )
		MATERIAL_VARIABLE_DEFINITION( SpotLightSkinnedModelMaterial, CameraPosition )
		MATERIAL_VARIABLE_DEFINITION( SpotLightSkinnedModelMaterial, BoneTransforms )
		MATERIAL_VARIABLE_DEFINITION( SpotLightSkinnedModelMaterial, ColorTexture )

		void SpotLightSkinnedModelMaterial::Initialize( Effect& effect )
	{
	...
	void SpotLightSkinnedModelMaterial::CreateVertexBuffer( ID3D11Device* device, const Mesh& mesh, ID3D11Buffer** vertexBuffer ) const
	{
	...
	void SpotLightSkinnedModelMaterial::CreateVertexBuffer( ID3D11Device* device, VertexSkinnedPositionTextureNormal* vertices, UINT vertexCount, ID3D11Buffer** vertexBuffer ) const
	{
	...
	UINT SpotLightSkinnedModelMaterial::VertexSize() const
	{
